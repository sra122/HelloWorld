...
class HelloWorldRouteServiceProvider extends RouteServiceProvider
{
    ...
    public function map(Router $router, ApiRouter $api)
    {
        ...
        $router->get('category', 'HelloWorld\Controllers\CategoryController@getCategories');
        ...
        $api->version(['v1'], ['middleware' => ['oauth']], function ($router) {
            ...
            $router->get('markets/panda-black/vendor-categories', 'HelloWorld\Controllers\CategoryController@getPBCategories');
            $router->get('markets/panda-black/vendor-attribute', 'HelloWorld\Controllers\CategoryController@getPBAttributes');
            ...
            //$router->get('markets/panda-black/create-order', 'HelloWorld\Controllers\OrdersController@getShippingInformation');
            $router->get('markets/panda-black/create-order-properties', 'HelloWorld\Controllers\OrdersController@getShippingInformation');
